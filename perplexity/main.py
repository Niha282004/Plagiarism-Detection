...
def check_plagiarism(text):
    ...
    word_count = result.get('words_count', 'Not Found')
    turnitin_index = result.get('percent', 'Not Found')
    matches = result.get('matches', 'Not Found')

    return {'word_count': word_count, 'turnitin_index': turnitin_index, 'matches': matches}
